    ...
    execute: function () {
      ...
      _export("GenericDatasource", GenericDatasource = function () {
        function GenericDatasource(instanceSettings, $q, backendSrv, templateSrv) {
          ...
          this.severityLevels = {};
          this.severityLevels[instanceSettings.jsonData.severity.critical] = "Critical";
          this.severityLevels[instanceSettings.jsonData.severity.high] = "High";
          this.severityLevels[instanceSettings.jsonData.severity.medium] = "Medium";
          this.severityLevels[instanceSettings.jsonData.severity.low] = "Low";
          this.severityLevels[instanceSettings.jsonData.severity.test] = "Test";
          this.severityLevels[instanceSettings.jsonData.severity.ciaas] = "Ciaas";
          this.q = $q;
